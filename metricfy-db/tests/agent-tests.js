...
// ESTA PRUEBA SE EJECUTA SIEMPRE, ANTES DE CADA PRUEBA QUE DECLAREMOS
...
// ESTA PRUEBA SE EJECUTA SIEMPRE, DESPUES DE CADA PRUEBA QUE DECLAREMOS
test.afterEach(() => {
...
// ESTA PRUEBA SE ENCARGA DE HACER EL SETUP
test.serial('Setup', t => {
...
test.serial('Agent#findByid', async t => {
  ...
  t.true(AgentStub.findById.calledOnce, 'findById should be called oncel')
  t.true(AgentStub.findById.calledWith(id), 'findById should be called with arg id')

  t.deepEqual(agent, agentFixtures.byId(id), 'Should be the same')
})

// CREATE OR UPDATE EXISTS
test.serial('Agent#createOrUpdate - exists', async t => {
  let agent = await db.Agent.createOrUpdate(single)

  t.true(AgentStub.findOne.called, 'findOne should be called on model')
  t.true(AgentStub.findOne.calledTwice, 'findOne sholud be called twice')
  t.true(AgentStub.update.calledOnce, 'updated should be called once')
